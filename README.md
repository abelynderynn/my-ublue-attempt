...
[![build-ublue](https://github.com/abelynderynn/my-ublue-attempt/actions/workflows/build.yml/badge.svg)](https://github.com/abelynderynn/my-ublue-attempt/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `abelynderynn/my-ublue-attempt` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/abelynderynn/my-ublue-attempt/blob/main/scripts/README.md) for more information.
...
- First rebase to the image unsigned, to get the proper signing keys and policies installed:
  ```
  sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/abelynderynn/my-ublue-attempt:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/abelynderynn/my-ublue-attempt:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/abelynderynn/my-ublue-attempt:20230403
```
...
To run the action, simply edit the `boot_menu.yml` by changing all the references to `abelynderynn/my-ublue-attempt` to your repository. This should trigger the action automatically.
